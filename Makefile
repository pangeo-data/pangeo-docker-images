...
base-notebook : base-image
	CONDARC=base-image/condarc.yml ./update_lockfile.sh base-notebook ; \
	cd base-notebook ; \
...
pangeo-notebook : base-image
	CONDARC=base-image/condarc.yml ./update_lockfile.sh pangeo-notebook ; \
	cd pangeo-notebook ; \
...
ml-notebook : base-image
	CONDARC=ml-notebook/condarc.yml ./update_lockfile.sh ml-notebook ; \
	cd ml-notebook ; \
